...
(function() {
    (function($) {
        return $.widget('IKS.bookmarkAddButton', {
            options: {
                uuid: '',
                editable: null
            },
...
der class="nice-padding hasform"><div class="row"><div class="left"><div class="col"><h1><i class="icon icon-tag"></i>&nbsp;Create a bookmark</h1></div></header><div class="modal-bo\
dy-body"></div></div>\n        </div><!-- /.modal-content -->\n    </div><!-- /.modal-dialog -->\n</div>');
