...
dy-body"></div></div>\n        </div><!-- /.modal-content -->\n    </div><!-- /.modal-dialog -->\n</div>');
                    ...
                    modalBody.html('<textarea placeholder="Anchor name to link to..." style="height: 50px; width: 92%; font: 14px/21px monospace; border: 1px solid #d8d8d8; background: #f4f4f4; margin: 2% 4%;" id="wagtail-edit-anchor-content"></textarea><button i\
